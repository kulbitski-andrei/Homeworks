...
class ExchangeRatesToBynTesting(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_2 = bank_module.Client(
...
class ExchangeRatesToEurTesting(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_3 = bank_module.Client(
            "test_client_2", 100, bank_module.usd)
        cls.client_4 = bank_module.Client(
            "test_client_3", 100, bank_module.byn)
...
class ExchangeRatesToUsdTesting(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_5 = bank_module.Client(
            "test_client_5", 100, bank_module.eur)
        cls.client_6 = bank_module.Client(
            "test_client_6", 100, bank_module.byn)
...
class UnexistingCurrency(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_7 = bank_module.Client(
            "test_client_7", 100, bank_module.byn)

    def test_to_aud(self):
        """Test conversion to the currency that doesn't exist in a system:
        australian dollars (AUD)"""
        with self.assertRaises(AttributeError):
            self.bank_instance.exchange_currency(
                self.client_7, bank_module.aud)  # pylint: disable=no-member
